...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, struct Elemento, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, struct Elemento,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, struct Elemento,
                                                struct ArbolBinario &);
...
void eliminaSubArbol(struct ArbolBinario & arbol, char );
