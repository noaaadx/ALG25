...
void insertarAlInicio(struct Lista & tad, const int & elemento) {
...
struct Nodo * crearNodo(const int &elemento, struct Nodo * siguiente) {
...
void insertarAlFinal(struct Lista & tad, const int &elemento) {
...
void insertarEnOrden(struct Lista & tad, const int &elemento) {
...
struct Nodo * obtenerNodoAnterior(const struct Lista & tad, const int &elemento) {
...
struct Nodo * seEncuentra(const struct Lista & tad, const int &elemento) {
    struct Nodo * recorrido = tad.cabeza;
...
void eliminaNodo(struct Lista & tad, const int  &elemento) {
    struct Nodo * ultimo = nullptr;
    struct Nodo * recorrido = tad.cabeza;
...
void imprime(const struct Lista & tad) {
    ...
    if (esListaVacia(tad)) {
        ...
        while (recorrido != nullptr) {
            ...
            cout << recorrido->elemento << " " << recorrido->elemento;
            recorrido = recorrido->siguiente;
        }
        cout << "]" << endl;
    }
