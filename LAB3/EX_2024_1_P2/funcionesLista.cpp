...
void insertarAlInicio(struct Lista & tad, const struct Elemento & elemento) {
...
void insertarAlFinal(struct Lista & tad, const struct Elemento & elemento) {
...
struct Elemento retornaCabeza(const struct Lista & tad){
